...
export const SHOT_CATALOG: Record<string, { label: string; onModel: boolean; framing: string }> = {
  ...
  flat_front:   { label: "Flat · Frente",       onModel: false, framing: "Product-only PACKSHOT: the garment laid FLAT and shot from directly above, FRONT side up, centered. The garment is laid FLAT on the surface and photographed straight from ABOVE (top-down flat-lay). It is COMPLETELY EMPTY and UNWORN: no body, no torso, no bust, no shoulders filled out, no invisible mannequin and NO ghost-mannequin effect. The fabric lies relaxed and slightly soft with natural creases where it settles, sleeves laid down flat alongside the body of the garment, collar flat. It must read as clothing resting on a surface — NOT as a garment standing up, holding a 3D body shape or being worn.  The ENTIRE garment must fit INSIDE the frame with comfortable margin: every sleeve, hem, collar and corner fully visible, nothing touching, overflowing or cropped by any edge. Leave roughly 10% empty background on all four sides. If a sleeve or hem extends diagonally, ZOOM OUT until the whole garment fits — never crop it. NO person, NO model, NO body — only the garment." },
  flat_back:    { label: "Flat · Espalda",      onModel: false, framing: "Product-only PACKSHOT of the garment laid FLAT and shot from directly above, BACK side up, centered. The garment is laid FLAT on the surface and photographed straight from ABOVE (top-down flat-lay). It is COMPLETELY EMPTY and UNWORN: no body, no torso, no bust, no shoulders filled out, no invisible mannequin and NO ghost-mannequin effect. The fabric lies relaxed and slightly soft with natural creases where it settles, sleeves laid down flat alongside the body of the garment, collar flat. It must read as clothing resting on a surface — NOT as a garment standing up, holding a 3D body shape or being worn.  The ENTIRE garment must fit INSIDE the frame with comfortable margin: every sleeve, hem, collar and corner fully visible, nothing touching, overflowing or cropped by any edge. Leave roughly 10% empty background on all four sides. If a sleeve or hem extends diagonally, ZOOM OUT until the whole garment fits — never crop it. NO person, NO model — only the garment." },
