...
export const FALLBACK_TOOLS: Record<string, ToolEntry> = {
  ...
  ad_creative_lab: { id: "ad_creative_lab", name: "Ad Creative Lab", category: "images", description: "Generate brand-consistent ad creatives.", icon: "sparkles", status: "active", pipeline: ["visual_guide", "prompts", "generate_batch", "review"] },
