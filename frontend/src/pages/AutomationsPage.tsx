    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-start justify-between">
                ...
                <button className="flex items-center gap-2 px-4 py-2 text-[13px] font-medium text-white bg-[var(--color-warm)] rounded-[var(--radius-sm)] hover:opacity-90 transition-opacity cursor-pointer">
                    <Plus size={14} />
                    New Automation
                </button>
            </div>
